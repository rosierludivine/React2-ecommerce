  ...
  return (
    <div className="">
      <div className=" ">
        <div className="p-10">
          <div className="">
            <div className=" bg-[url('./assets/Blanc&Rouge.png')] "></div>
    ...
    <div className=" w-full overflow-auto flex flex-row flex-nowrap gap-12 ">
      <div className="flex flex-col items-center ">
        <h3 className=" ">Article de Jordan 1</h3>
      </div>
    </div>
    ...
    <div className="columns-3">
          <div className="">
            <div className="columns-3">
              <div className=" bg-[url('./assets/jordan.jpg')]"></div>
              <h3 className="font-title text-xl ">Jordan 1</h3>
              <div className='flex flex-row justify-center columns-3'>
